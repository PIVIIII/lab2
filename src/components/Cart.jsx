...
const CartDrawer = ({ isOpen, onClose }) => {
  ...
  return (
    <>
      ...
      <div
        className={`fixed top-0 right-0 h-full w-80 bg-white dark:bg-gray-800 z-50 shadow-2xl transform transition-transform duration-300 ${isOpen ? 'translate-x-0' : 'translate-x-full'}`}
      >
